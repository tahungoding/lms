...
<head>
    ...
    <!-- Perfect Scrollbar -->
    <link type="text/css" href="{{asset('asset/back/vendor/perfect-scrollbar.css')}}" rel="stylesheet">

    <!-- App CSS -->
    <link type="text/css" href="{{asset('asset/back/css/app.css')}}" rel="stylesheet">
    <link type="text/css" href="{{asset('asset/back/css/app.rtl.css')}}" rel="stylesheet">

    <!-- Material Design Icons -->
    <link type="text/css" href="{{asset('asset/back/css/vendor-material-icons.css')}}" rel="stylesheet">
    <link type="text/css" href="{{asset('asset/back/css/vendor-material-icons.rtl.css')}}" rel="stylesheet">

    <!-- Font Awesome FREE Icons -->
    <link type="text/css" href="{{asset('asset/back/css/vendor-fontawesome-free.css')}}" rel="stylesheet">
    <link type="text/css" href="{{asset('asset/back/css/vendor-fontawesome-free.rtl.css')}}" rel="stylesheet">

    <!-- ion Range Slider -->
    <link type="text/css" href="{{asset('asset/back/css/vendor-ion-rangeslider.css')}}" rel="stylesheet">
    <link type="text/css" href="{{asset('asset/back/css/vendor-ion-rangeslider.rtl.css')}}" rel="stylesheet">
</head>
...
<body class="layout-default">
    ...
    <!-- jQuery -->
    <script src="{{asset('assets/back/vendor/jquery.min.js')}}"></script>

    <!-- Bootstrap -->
    <script src="{{asset('assets/back/vendor/popper.min.js')}}"></script>
    <script src="{{asset('assets/back/vendor/bootstrap.min.js')}}"></script>

    <!-- Perfect Scrollbar -->
    <script src="{{asset('assets/back/vendor/perfect-scrollbar.min.js')}}"></script>

    <!-- DOM Factory -->
    <script src="{{asset('assets/back/vendor/dom-factory.js')}}"></script>

    <!-- MDK -->
    <script src="{{asset('assets/back/vendor/material-design-kit.js')}}"></script>

    <!-- Range Slider -->
    <script src="{{asset('assets/back/vendor/ion.rangeSlider.min.js')}}"></script>
    <script src="{{asset('assets/back/js/ion-rangeslider.js')}}"></script>

    <!-- App -->
    <script src="{{asset('assets/back/js/toggle-check-all.js')}}"></script>
    <script src="{{asset('assets/back/js/check-selected-row.js')}}"></script>
    <script src="{{asset('assets/back/js/dropdown.js')}}"></script>
    <script src="{{asset('assets/back/js/sidebar-mini.js')}}"></script>
    <script src="{{asset('assets/back/js/app.js')}}"></script>

    <!-- App Settings (safe to remove) -->
    <script src="{{asset('assets/back/js/app-settings.js')}}"></script>
